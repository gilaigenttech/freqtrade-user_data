...
class AlexStrategyFinalV8(IStrategy):
    ...
    Use at your own risk. This is a simple example strategy and should be used for educational purposes only.
    """
    ...
    # Were letting the model decide when to sell
    # Trailing stop:
    timeframe = "1h"
    can_short = True
    ...
    def set_freqai_targets(self, dataframe: DataFrame, metadata: Dict, **kwargs) -> DataFrame:
        ...
        w = [self.w0.value, self.w1.value, self.w2.value, self.w3.value, self.w4.value, self.w5.value, self.w6.value,
             self.w7.value, self.w8.value]
